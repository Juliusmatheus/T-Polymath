          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                ...
                <div className="text-3xl font-bold text-green-600 mb-6">$8,999</div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-green-500 relative">
                ...
                <div className="text-3xl font-bold text-green-600 mb-6">$19,999</div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center">
                    <CheckCircle size={16} className="text-green-500 mr-2" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                ...
                <div className="text-3xl font-bold text-green-600 mb-6">$49,999</div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center">
                    <CheckCircle size={16} className="text-green-500 mr-2" />
